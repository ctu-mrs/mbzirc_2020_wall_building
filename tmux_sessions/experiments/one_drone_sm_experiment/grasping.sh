...
'
  'Control' 'waitForRos; roslaunch mrs_general core.launch config_odometry:=./custom_configs/odometry.yaml config_gain_manager:=./custom_configs/gain_manager.yaml config_uav_manager:=./custom_configs/uav_manager.yaml config_landoff_tracker:=./custom_configs/landoff_tracker.yaml config_constraint_manager:=./custom_configs/constraint_manager.yaml WORLD_FILE:=./world_local.yaml config_mpc_controller:=./custom_configs/mpc_controller.yaml custom_config:=./custom_configs/nimbro.yaml config_mpc_tracker:=./custom_configs/mpc_tracker.yaml
'
  'ScanPlanner' 'waitForRos; roslaunch arena_scan_planner arena_scan_planner.launch WORLD_FILE:=./world_local.yaml
'
  'PlanKeeper' 'waitForRos; roslaunch plan_keeper uav.launch
'
  'Flexbee'  'waitForControl; roslaunch mrs_flexbe_behaviors run_wall_sm.launch
'
  'Mapping'  'waitForControl; roslaunch brick_mapping brick_mapping.launch
'
